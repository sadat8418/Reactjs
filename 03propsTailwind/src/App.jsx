...
//array , obj pass from APp.jsx to props in Card.jsx
let myObj = {
  username: "hitesh",
  age: 21
}
let newArr = [1, 2, 3]
  ...
  return (
    <>
      ...
      <h1 className='bg-green-400 text-black p-4 rounded-xl mb-4'>Sadat</h1>
      <div className="flex font-sans mb-4"  >
  <div className="flex-none w-56 relative">
      <img src="src\assets\pexels-photo-1539936.jpeg" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  ...
  <form className="flex-auto p-6">
    ...
    <Card username= "Sadat code" ></Card>
    <Card username="Sadat again" btnText='Love me' src="src\assets\pexels-photo-2026960.jpeg" />
    <Card username="Sadat thrice" src="\src\assets\pexels-photo-713069.jpeg" />
    </>
  )
}
